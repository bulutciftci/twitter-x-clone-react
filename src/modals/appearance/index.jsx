...
import {colors} from "../../../utils/utils.consts.jsx";
                        ...
                        <section>
                            ...
                            <div
                                ...
                                <button
                                    ...
                                    <div
                                        className="w-10 h-10 rounded-full flex-shrink-0 group-hover:bg-black/10 flex items-center justify-center">
                                        <div
                                ...
                                <button
                                    ...
                                    className={classNames("h-16 pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] font-bold border border-white/10 rounded group flex items-center gap-1.5", {
