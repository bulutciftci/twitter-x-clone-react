...
import {colors, fontSizes} from "../../../utils/utils.consts.jsx";
                    ...
                    <div className="border border-[color:var(--background-third)] px-4 flex py-3 gap-3 rounded-2xl">
                        ...
                        <div className="flex-1 flex flex-col">
                            ...
                            <div className="text-[color:var(--color-base)] leading-5  ">
                                ...
                                <Link className="text-[#1d9bf0] hover:underline px-0.5" to="/x">
                                    @X
                                </Link>
                ...
                <div>
                    ...
                    <div className="grid gap-3">
                        ...
                        <section>
                            ...
                            <div
                                className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex items-center gap-5">
                                   ...
                                   <div className="flex justify-between absolute w-[calc(100%+16px)] -top-3.5 -left-[8px]">
                                       {fontSizes.map(fs => (
                                           <button
                                               ...
                                               className={classNames("before:absolute before:inset-0 before:rounded-full before:hover:bg-[color:var(--color-primary)] before:opacity-15  w-8 h-8 rounded-full flex items-center justify-center  relative",{
                        ...
                        <section>
                            ...
                            <div
                                className="bg-[color:var(--background-secondary)] py-2 rounded-2xl flex justify-around items-center">
                                {colors.map((c, index) => (
                        ...
                        <section>
                            <h6 className="text-[color:var(--color-base-secondary)] mb-1 leading-5 text-[13px] font-bold">Arka
                                plan</h6>
                            <div
                                className="py-2 px-4 mb-3 grid grid-cols-3 gap-2 bg-[color:var(--background-secondary)] rounded-2xl">
                                ...
                                <button
                                    ...
                                    <div
                                        className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-black/10 flex items-center justify-center">
                                        <div
                                ...
                                <button
                                    ...
                                    className={classNames("h-[62px] pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] font-bold border border-white/10 rounded group flex items-center gap-1.5", {
                                    ...
                                    <div
                                        ...
                                        <div
                                            className={classNames("w-[20px] h-[20px] rounded-full border-2 border-[#5c6e7e] flex items-center justify-center", {
                                ...
                                <button
                                    ...
                                    <div
                                        className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-white/10 flex items-center justify-center">
                                        <div
                                            className={classNames("w-[20px] h-[20px] rounded-full border-2 border-[#3e4144] flex items-center justify-center", {
