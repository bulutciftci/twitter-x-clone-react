...
export default function Search() {
    ...
    return(
        ...
        >
            <label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] block w-full relative group border border-transparent focus-within:bg-[color:var(--background-primary)] focus-within:border-[color:var(--color-primary)]">
                ...
                {(query && focus) && (
                    <button
                        type="button"
                        onClick={() => setQuery('')}
                        className="w-[22px] h-[22px] rounded-full bg-[color:var(--color-primary)] flex items-center justify-center text-black absolute top-1/2 -translate-y-1/2 min-w-[22px] right-3 ">
            ...
            {focus && (
                <div
                    ...
                    className="absolute w-[350px] top-full -translate-y-1  -left-px bg-[color:var(--background-primary)] shadow-box border focus-within:border-[#1d9bf0] max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
