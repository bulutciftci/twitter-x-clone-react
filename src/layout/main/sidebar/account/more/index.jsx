        ...
        <div>
            {accounts.map(account => (
                ...
                <button
                    ...
                    className={classNames("py-3 px-4 flex items-center text-left hover:bg-[color:var(--background-third)]  w-full transition-colors ", {
            ...
            <button
                className="py-3 px-4 text-left transition-colors hover:bg-[color:var(--background-third)] w-full leading-[1.25rem] font-bold">
